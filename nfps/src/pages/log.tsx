...
const Log: NextPage = () => {
  return (
    <div className="min-h-screen grid place-items-center bg-slate-50">
      <div className="max-w-[1200px] pt-12 pb-40">
        <div className="sm:px-6 w-full">
          ...
          <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 mt-8 rounded-xl border shadow">
              ...
              <table className="w-full whitespace-nowrap">
                <tbody>
                  ...
                  >
                    <td>
                      <div className="ml-5">
                        <div className="bg-slate-50 rounded-sm w-5 h-5 flex flex-shrink-0 justify-center items-center relative">
                          <input
                    ...
                    <td className="pl-4">
                      <button className="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-slate-50 focus:outline-none">
                        View
                      </button>
                    </td>
                    <td>
                  ...
                  >
                    ...
                    <td className="pl-5">
                      <button className="py-3 px-3 text-sm leading-none text-gray-700 bg-gray-100 hover:bg-slate-50 rounded focus:outline-none">
                        Due Today at 18:00
                      </button>
                    </td>
                    <td className="pl-4">
