...
export const eventDataArray: Event[] = [
  ...
  },
  {
    id: 29,
    project_id: 111,
    title: "추운 겨울 대비 패딩 하나씩!",
    content: "<p>패딩 하나씩 마련해 가세요~</p>",
    metadata: null,
  ...
  },
  {
    ...
    metadata: null,
    start_dt: moment(new Date()).add(-5, "d").format(),
    end_dt: moment(new Date()).add(1, "d").add(1, "h").format(),
  ...
  },
  {
    ...
    content: "<p>테스트</p>",
    metadata: null,
    start_dt: moment(new Date()).format(),
    end_dt: moment(new Date()).add(5, "d").format(),
  ...
  },
  {
    ...
    content: "<p>테스트</p>",
    metadata: null,
    start_dt: moment(new Date()).add(1, "d").add(1, "h").format(),
    end_dt: moment(new Date()).add(5, "d").format(),
  ...
  },
  {
    id: 92,
    project_id: 111,
    title: "갤럭시 S23 사전예약 이벤트",
    content: "<p>갤럭시 S23 사전예약 이벤트</p>",
    metadata: null,
    start_dt: moment(new Date()).add(3, "d").add(1, "h").format(),
    end_dt: moment(new Date()).add(10, "d").format(),
